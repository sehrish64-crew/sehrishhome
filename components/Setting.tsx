...
import IsrTaxes from "../components/Isrtaxes";
import MaterialCostForm from "../components/MaterialCostForm";


const Apex = dynamic(() => import("./Apexchart"), {
    ssr: false,
});
...
import DateCom from "./Datepicker";
...
export default function Patient() {
    ...
    const tabs = ["General", "Security", "Sessions", "External Doctors", "ISR Taxes", "Unit & Cost Type"];
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                <div className="add_btn">
                                                    ...
                                                    >
                                                        ...
                                                        <span className="text-base font-regular">Create</span>
                                                    </button>
                                                                                ...
                                                                                <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                                                                    ...
                                                                                    <div className="flex gap-1 border-b border-[#E5E7EB] pb-4 w-full">
                                                                                        ...
                                                                                        <div className="flex flex-col">
                                                                                            ...
                                                                                            <span className="text-[#A1A5AA] font-regular">
                                                                                                Provide details to add a new external doctor
                                                                                            </span>
                                                                                        </div>
                                                                                    </div>
                                                ...
                                                <table className="min-w-full">
                                                    <thead className="bg-gray-50 sticky top-0">
                                                        <tr>
                                                            ...
                                                            <th className="px-6 py-3 text-left text-sm font-medium text-[#475467] uppercase tracking-wider">Full Name</th>
                                                            <th className="px-6 py-3 text-left text-sm font-medium text-[#475467] uppercase tracking-wider">Spatiality</th>
                                                            <th className="px-6 py-3 text-left text-sm font-medium text-[#475467] uppercase tracking-wider">Phone Number</th>
                                                            <th className="px-6 py-3 text-left text-sm font-medium text-[#475467] uppercase tracking-wider">Email Address</th>
                                                            <th className="px-6 py-3 text-left text-sm font-medium text-[#475467] uppercase tracking-wider">Address</th>
