  ...
  return (
    <div className="flex flex-col h-full bg-white lg:rounded-r-lg">
      ...
      <div className="set-header pb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 flex-shrink-0 lg:rounded-tr-lg">
        <h1 className="text-3xl font-regular text-[#144A6C]">Treatments</h1>
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
          ...
          <div>
            ...
            >
              ...
              <span className="text-base font-regular">Treatments</span>
            </button>
                            ...
                            <div className="flex gap-1 border-b border-[#E5E7EB] pb-4 w-100">
                              <div className="user-icon">
                                ...
                                >
                                  ...
                                  <rect
                                    ...
                                    height={43}
                                    rx="21.5"
                                    stroke="url(#paint0_linear_220_4856)"
                                    strokeOpacity="0.3"
                                  />
                                  <path
                                    d="M16.6034 16.4437L16.3913 16.8149C15.7055 18.015 15.4393 19.4095 15.6347 20.7779C15.9848 23.2281 16.8791 25.5689 18.252 27.6283L18.3728 27.8094C18.7992 28.4491 19.7838 28.2693 19.9567 27.5202L20.7818 23.9445C21.0799 22.6526 22.9197 22.6526 23.2178 23.9445L24.043 27.5202C24.2158 28.2693 25.2004 28.4491 25.6268 27.8094L25.7476 27.6283C27.1205 25.5689 28.0148 23.2281 28.3649 20.7779C28.5603 19.4095 28.2941 18.015 27.6083 16.8149L27.3962 16.4437C26.4064 14.7114 23.9818 14.5224 22.7354 16.0804C22.3583 16.5518 21.6413 16.5518 21.2642 16.0804C20.0178 14.5224 17.5932 14.7114 16.6034 16.4437Z"
                                    stroke="#144A6C"
                                    strokeWidth="1.5"
                                    strokeLinecap="round"
                                  />
                              ...
                              <div className="flex flex-col">
                                ...
                                <span className="text-[#A1A5AA] font-regular">
                                  Provide details to create Treatment
                                </span>
                              </div>
                              <hr />
                            </div>
